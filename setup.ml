...
(* OASIS_START *)
(* DO NOT EDIT (digest: ab11f4e996451746a2cd55834fd1245c) *)
(*
...
let setup_t =
  {
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build auxiliary library \"bookaml_ocsigen\" (implements an engine using Ocsigenserver's Ocsigen_http_client)";
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build auxiliary library \"bookaml_ocamlnet\" (implements an engine using Ocamlnet's Netclient)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("tyxml.parser", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "r\162GKd\179\245j\211\174\179\025\218\006\249\145";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
